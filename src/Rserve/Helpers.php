...
class Helpers {
   ...
   * @param int $o offset
   */
  public static function int8($buf, $o = 0) {
    return ord($buf[$o]);
  }
   ...
   * @param int $o offset
   */
  public static function int24($buf, $o = 0) {
   ...
   * @param int $o offset
   */
  public static function int32($buf, $o=0) {
   ...
   * @param $i
   */
  public static function mkint8($i) {
    return chr($i & 255);
  }
   ...
   * @return string
   */
  public static function mkint32($i) {
    $r = chr($i & 255); 
    $i >>= 8; 
    $r .= chr($i & 255); 
    $i >>=8; 
   ...
   */
  public static function mkint24($i) {
    $r = chr($i & 255); 
    $i >>= 8; 
    $r .= chr($i & 255); 
    $i >>=8; 
   ...
   * @param double $v 
   */
  public static function mkfloat64($v) {
    return pack('d', $v);
  }
   ...
   * @param $o
   */
  public static function flt64($buf, $o = 0) {
    $ss = substr($buf, $o, 8);
   ...
   */
  public static function _rserve_make_packet($cmd, $data) {
    // [0]  (int) command
   ...
   */
  public static function _rserve_make_data($type, $string) {
    if($type == \Rserve\Connection::DT_STRING) {
      $string .= chr(0);
    }
